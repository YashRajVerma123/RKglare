...
import { Send, Loader2, Star, Trash2, Smile, MessageSquareReply, Pencil, X, MoreHorizontal, Paperclip, Image as ImageIcon } from 'lucide-react';
    ...
    useEffect(() => {
        ...
        const unsubscribe = onSnapshot(q, (snapshot) => {
            ...
            const isAtBottom = messagesEndRef.current ? 
                (messagesEndRef.current.getBoundingClientRect().bottom - window.innerHeight) < 100 : true;
